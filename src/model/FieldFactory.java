...
public class FieldFactory {
     ...
     * 
     * @param type
     *            the String value of the {@link FieldValue} type to create
     * @param name
     *            the name to give the new {@link FieldValue}
     ...
     * 
     * @param item
     *            the {@link FieldValue} used to determine its type
     ...
     * 
     * @param item
     *            the {@link FieldValue} used to determine its query string
     ...
     * 
     * @param typ
     *            the {@link FieldValue} string type used to determine its query
     *            string
    ...
    /**
     * Shortens a String over 40 characters into a String with 40 characters and
     * appends "..." to that shortenedString
     * 
     * @param str
