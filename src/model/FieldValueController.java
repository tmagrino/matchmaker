...
public class FieldValueController {
     ...
     */
    public static FieldValue createFieldValue(EntityManager em,
                                              String description,
                                              String type) throws InstantiationException,
                                                           IllegalAccessException {
        EntityTransaction tx = em.getTransaction();
        System.out.println("Creating a field");
        System.out.println("Searching if " + type + ":" + description +
                           " exists");
    ...
    public static void removeFieldValue(EntityManager em, FieldValue value)
        ...
        String query = "select a FROM LATESTADDITION a WHERE a.type = \"" +
                       type + "\" " + "AND a.name = \"" + description + "\"";
        List<LatestAddition> results = (List<LatestAddition>) em.createQuery(query)
                                                                .getResultList();
        try {
     ...
     */
    public static FieldValue getFieldValueById(EntityManager em, long id,
                                               String type) throws InstantiationException,
                                                            IllegalAccessException {
        ...
        @SuppressWarnings("unchecked")
        List<FieldValue> itens = (List<FieldValue>) em.createQuery(query)
                                                      .getResultList();
        try {
            return itens.get(0);
        } catch (Exception e) {
     ...
     */
    public static void addStudent(EntityManager em, FieldValue item,
                                  Student s) {
        EntityTransaction tx = em.getTransaction();
        if (item == null || s == null) {
            return;
     ...
     */
    public static void removeStudent(EntityManager em, FieldValue item,
                                     Student s) {
        EntityTransaction tx = em.getTransaction();
        if (item == null || s == null) {
            return;
     ...
     */
    public static void addResearcher(EntityManager em, FieldValue item,
                                     Researcher r) {
        EntityTransaction tx = em.getTransaction();
        if (item == null || r == null) {
            return;
     ...
     * Add student to the item table.
     */
    public static void addProject(EntityManager em, FieldValue item,
                                  Project p) {
        EntityTransaction tx = em.getTransaction();
        if (item == null || p == null) {
            return;
     ...
     * Remove a student from the item table.
     */
    public static void removeProject(EntityManager em, FieldValue item,
                                     Project p) {
        EntityTransaction tx = em.getTransaction();
        if (item == null || p == null) {
            return;
    ...
    public static String[] getArrayOfOfType(EntityManager em, String type) {
        ...
        try {
            @SuppressWarnings("unchecked")
            List<FieldValue> it = (List<FieldValue>) em.createQuery(query)
                                                       .getResultList();
     ...
     */
    public static List<FieldValue> getListOfType(EntityManager em,
                                                 String type) {
        String query = FieldFactory.getQuery(FieldFactory.createField(type,
                                                                      ""));
        try {
            @SuppressWarnings("unchecked")
            List<FieldValue> items = (List<FieldValue>) em.createQuery(query)
                                                          .getResultList();
            return items;
        } catch (Exception e) {
    ...
    public static FieldValue getItemByDescription(EntityManager em,
        ...
        try {
            ...
            System.out.println("ItemByDescription: " + type + " + " +
    ...
    public static List<LatestAddition> getLatestAddedFields(EntityManager em) {
        ...
        List<LatestAddition> items = (List<LatestAddition>) em.createQuery(query)
                                                              .getResultList();
        return items;
    }
