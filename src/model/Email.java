...
public class Email {
    private static String from = "researchmatchmaker.email"; // GMail user name
                                                             // (just the part
                                                             // before
                                                             // "@gmail.com")
    ...
    public static void sendAcceptingMessage(Student s, Application a) {
        ...
        body = "Dear " + s.getName() +
               ...
               a.getApplicationProject().getResearchers().get(0).getName() +
               " on " +
               a.getApplicationProject().getResearchers().get(0).getEmail() +
               " or check the project " + "page here: " +
    ...
    public static void sendInvitationMessage(Student s, Application a) {
        ...
        if (a.getApplicationProject().getResearchers().size() > 1) {
            body = "Dear " + s.getName() + ",\n\nProfessors " +
                   a.getApplicationProject().getResearchersString() +
                   " have invited you to apply to their project " +
                   a.getApplicationProject().getName() +
            ...
            body = "Dear " + s.getName() + ",\n\nProfessor " +
                   a.getApplicationProject().getResearchersString() +
                   " has invited you to apply for the project " +
                   a.getApplicationProject().getName() +
                   ". You can check it out here: " +
                   a.getApplicationProject().getURL() + "\n\n" + signature;
        }
    ...
    public static void sendDeleteItemMessage(Student s, String description,
                                             String type) {

        body = "Dear " + s.getName() + ",\n\nYour " + type + " named " +
               description + " has been removed by an Administrator." +
    ...
    public static void sendDeleteItemMessage(Researcher r, String description,
                                             String type) {
