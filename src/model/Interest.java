 ...
 * method visibilities, only getter methods can be accessed externally. To
 * create or alter instances of this class, use {@link FieldValueController}.
 * 
 * @author Jan Cardenas
...
public class Interest extends FieldValue {
    ...
    /**
     * @param name
     *            the name to set to this Interest
     */
    @Override
    ...
    /**
     * Adds a {@link Student} to this Interest. Updates both sides of the
     * Student and Interest relationship.
     * 
     * @param s
     *            the {@link Student} to add to this Interest
     */
    ...
    /**
     * Removes a {@link Student} from this Interest. Updates both sides of the
     * Student and Interest relationship.
     * 
     * @param s
     *            the {@link Student} to remove from to this Interest
     */
    ...
    /**
     * Adds a {@link Researcher} to this Interest. Updates both sides of the
     * Researcher and Interest relationship.
     * 
     * @param r
     *            the {@link Researcher} to add to this Interest
     */
    ...
    /**
     * Removes a {@link Researcher} from this Interest. Updates both sides of
     * the Researcher and Interest relationship.
     * 
     * @param r
     *            the {@link Researcher} to remove from to this Interest
     */
    ...
    /**
     * Adds a {@link Project} to this Interest. Updates both sides of the
     * Project and Interest relationship.
     * 
     * @param p
     *            the {@link Project} to add to this Interest
     */
    ...
    /**
     * Removes a {@link Project} from this Interest. Updates both sides of the
     * Project and Interest relationship.
     * 
     * @param p
     *            the {@link Project} to remove from to this Interest
     */
    ...
    /**
     * Removes all {@link Student}s, {@link Researcher}s, and {@link Project}s
     * from this Interest
     */
    void removeElements() {
        removeStudents();
     ...
     * 
     * @param o
     *            the {@link FieldValue} to be compared to
     */
