 ...
 * <p>
 * An entity created in parallel with a {@link FieldValue} used to faciliate
 * generating lists of recently added {@link FieldValue}s
 * <p>
 * Has no direct link with its associated {@link FieldValue}, but contains
 * information about its name and type to be able to search for the associated
 * {@link FieldValue}
 * 
 * @author Jan Cardenas
 * @author Chris Song
...
public class LatestAddition {
     ...
     * 
     * @param type
     *            the {@link FieldValue} type of the associated
     *            {@link FieldValue}
     * @param name
     *            the name of the associated {@link FieldValue}
     */
    ...
    /**
     * 
     * @return the id of this LatestAddition in the LATESTADDITION table of the
     *         database
     */
    public long getId() {
        return id;
    ...
    /**
     * 
     * @return the {@link Date} of the creation of the associated
     *         {@link FieldValue}
     */
