...
public class ApplicationController {
    ...
    public static Application createApplication(EntityManager em, Student s,
                                                Project p,
    ...
    public static void acceptInvitation(EntityManager em, Application a,
                                        String response) {
        EntityTransaction tx = em.getTransaction();
        if (a == null) {
            return;
    ...
    public static void editStudentResponse(EntityManager em, Application a,
                                           String response) {
        EntityTransaction tx = em.getTransaction();
        if (a == null) {
            return;
    ...
    public static List<Application> getApplicationList(EntityManager em) {
        ...
        try {
            ...
            List<Application> mylist = (List<Application>) em.createQuery(query)
                                                             .getResultList();
    ...
    public static Application getApplication(EntityManager em, Student s,
                                             Project p) {
