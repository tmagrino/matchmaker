...
public class Project implements Serializable {
    ...
    public Project(String name, String description, String url, Researcher res,
        ...
        this(name, description, url,
             new ArrayList<Researcher>(Arrays.asList(res)), area, skills);
    }

    public void updateProject(String name, String description, String url,
                              List<Researcher> res, List<Interest> area,
                              List<Skill> skills) {
        if (name != null && name != "") {
            if (name.length() >= MAX_NAME_CHARS) {
    ...
    public void updateProject(String name, String description, String url,
                              Researcher res, List<Interest> area,
                              List<Skill> skills) {
        updateProject(name, description, url,
                      new ArrayList<Researcher>(Arrays.asList(res)), area,
                      skills);
    }
