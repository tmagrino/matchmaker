...
public class Project implements Serializable {
    ...
    public Project(String name, String description, String url,
            List<Researcher> res, List<Interest> area, List<Skill> skills) {
    ...
    public void updateProject(String name, String description, String url, List<Researcher> res, List<Interest> area, List<Skill> skills) {
        if (name != null && name != "") {
            if (name.length() >= MAX_NAME_CHARS) {
                this.name = name.substring(0, MAX_NAME_CHARS);
            } else {
