		...
		<div class="wrapper">
			<div id="container" class="clearfix">
				<div class="sidebar">
					...
					<div id="sidenav">
						<ul>
							<li class="first"><a href="prof-profile.jsp">View Profile</a></li>
							<li><a class="selected" href="edit-prof-profile.jsp">Edit Profile</a></li>
						</ul>
					</div>
				</div>
				<div class="main">
					<ul class="tabrow">
						...
						<li><a href="prof-projects.jsp">My Projects</a></li>
