...
<%
  ...
  String[] attributes = {ProjectController.TITLE, ProjectController.AREA,
                         ProjectController.SKILL, ProjectController.URL,
...
<div class="content">
  ...
  ></div>
  <div id="all-required_skills" class="hidden"
    title="All Skills Suggestions"
  ></div>
  <h1>My Projects</h1>
    ...
    <table class="info">
      ...
      <tr>
        ...
        <td class="field">
          ...
          <p>
            <a
              class="edit-btn <%= attr.length() > 80 ?  "extended" : "" %>"
              href="#"
        ...
        <td class="field">
          ...
          <p class="editable hidden">
            ...
            <input name="<%=attr.replaceAll(" ", "_").toLowerCase() %>"
              value="<%=ProjectController.getAttribute(p, attr) %>"
              type="text"
            />
            <% } %>
          </p>
