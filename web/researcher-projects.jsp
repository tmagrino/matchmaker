...
<div class="content">
	...
	<h1>
		...
		<a class="actionButton delete"
			href="remove-project.jsp?id=<%=p.getId()%>"
		><img class="delete" src="images/Delete.png" alt="delete" border="0"
			alt="Delete application"
		/></a>
	</h1>
	<table class="project-list searchable researcher-projects"
		data-empty="No students have been accepted yet"
	>
		...
		<%for (Application a : students){
					...
					%>
		<tr>
			<td class="no-title"><a class="actionButton remove"
				href="remove-student.jsp?id=<%=a.getId()%>"
			>Remove</a></td>
			<td><p>
