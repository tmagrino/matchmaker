...
if(session.getAttribute("adminUser") != null){%> <%=session.getAttribute("adminUser")%>
	...
	<center>
		<b> Please exit your browser and sign out of SideCar to clear your
			credentials.
			<p>
				If you authenticate using CUWebLogin, please be sure to read the
				guidelines<br> on how to <a
					href='http://www.cit.cornell.edu/services/identity/cuweblogin/more.html'
				>clear your CUWebLogin credentials</a>.
			</p>
		</b>
	</center>
