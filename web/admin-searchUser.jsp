		...
		<li class="clearfix">
			<div class="accounts">
				<form action="admin-searchUser.jsp" method="Get">
					...
					<% }%><br /> <font size="4"><b>Search By Name : </b>&nbsp;</font>
					<%if(name != null) {%>
					...
					<tr>
						<td>
							...
							<div class="status">
								...
								<form action="profile.jsp" method="get">
									...
									<input type="submit" value="Act as User" size=20
										style="width: 10em; height: 2em"
									/>
								</form>
						...
						<td align="left" rowspan="2">
							<form action="update-Role.jsp" method="Get">
								...
								<p align="left">
									&nbsp;&nbsp;<input type="checkbox" name="researcherRole"
										value="Researcher" checked="checked"
									/>Project Leader
									<%} else{ %>
								...
								<p align="left">
									&nbsp;&nbsp;<input type="checkbox" name="studentRole"
								...
								<p align="left">
									...
									/>Student &nbsp;&nbsp;
									<% }%>
									<input type="hidden" name="userNetID"
										value="<%=request.getParameter("netID") %>"
									/> <input type="hidden" name="userName"
										value="<%=request.getParameter("name") %>"
									/>
								<p>
									<br>
									<input type="submit" value="Update Roles" size=20
										style="width: 10em; height: 2em"
									/>
							</form>
						</td>
						<!-- Close td with role checkboxes -->
					</tr>
					<!--  Close role tr -->
				...
				<%} %>
				<h4 class="subheading">
					<i>&nbsp;&nbsp;<%=(request.getParameter("searchDisplay") == null) ? "" : request.getParameter("searchDisplay")%></i>
				</h4>
